...
class Decimal {
	...
	/** Add a value to another. Has almost no effect on very large numbers. */
	static plus(value: DecimalSource, other: DecimalSource): Decimal;
	/** Subtract a value from another. Has almost no effect on very large numbers. */
	...
	/**
	 * Absolute value, convert number to positive.
	 */
	abs(): Decimal;
	neg(): Decimal;
	negate(): Decimal;
	...
	/** Picks the bigger value of the two. */
